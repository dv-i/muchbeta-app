...
export default function Example(): JSX.Element {
	const [generePreferences, setGenerePreferences] = useState<
		Option | Option[]
	>([
		{
			value: "comedy",
				...
				<div className="divide-y divide-white/5">
					...
					<div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
						<div>
							...
							<p className="mt-1 text-sm leading-6 text-gray-500">
								Unlock a world of curated content by sharing
								your favorite genre! Let us transform your
								preferences into a personalized content
								experience using our cutting-edge algorithms.
							</p>
						</div>
								...
								<div className="col-span-full">
									...
									<div className="mt-2">
										<Select
											...
											value={generePreferences ?? null}
											isMultiple
											onChange={function (
												value: SelectValue
											): void {
												value &&
													setGenerePreferences(value);
											}}
											primaryColor={"teal"}
										/>
									</div>
					...
					<div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
						<div>
							...
							<p className="mt-1 text-sm leading-6 text-gray-500">
								No longer want to use our service? You can
								delete your account here. This action is not
